...
authenticator = IAMAuthenticator('9ZB88wntxIMv73M5XeoFhp6ETPtmKPOrBItiHi9Fx77B')
text_to_speech = TextToSpeechV1(
    authenticator=authenticator
)
text_to_speech.set_service_url('https://api.eu-gb.text-to-speech.watson.cloud.ibm.com/instances/43c04d30-8f8e-4fa7-9c4d-f5895c3a4590')
...
while True:
    ...
    if(a["data"][0]["masked"]==0):       
        ...
        text='Please wear the mask to enter inside'
        filename='new6.mp3'
        playfile()
        ...
        text='Hello, you can enter inside'
        filename='new5.mp3'
        playfile()
        while not(pygame.mixer.music.get_busy()):
            pygame.mixer.quit()
